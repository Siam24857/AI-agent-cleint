    ...
    <main className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12">
      <div className="max-w-4xl mx-auto px-4">
        <div className="flex items-center gap-2 mb-2">
          <BarChart3 className="h-7 w-7 text-[#ffea00]" />
        ...
        <div className="bg-[#2d2d2d] rounded-xl shadow p-6 mb-6">
          ...
          <input
            ...
            className="w-full rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#ffea00] mb-4"
          />
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#ffea00]"
            />
            <button
              onClick={addSkill}
              className="bg-[#ffea00] text-[#1a1a1a] px-4 py-2 rounded-md font-medium hover:bg-[#d4b800]"
            >
          ...
          <div className="flex flex-wrap gap-2 mt-4">
            {skills.map((s) => (
              <span
                key={s}
                className="bg-indigo-50 text-[#ffea00] px-3 py-1 rounded-full text-sm flex items-center gap-1"
              >
                {s}
                <button onClick={() => removeSkill(s)} className="text-[#ffea00] hover:text-red-500">
          ...
          <Link
            ...
            className="mt-6 inline-flex items-center gap-2 bg-[#ffea00] text-[#1a1a1a] px-6 py-3 rounded-md font-semibold hover:bg-[#d4b800]"
          >
